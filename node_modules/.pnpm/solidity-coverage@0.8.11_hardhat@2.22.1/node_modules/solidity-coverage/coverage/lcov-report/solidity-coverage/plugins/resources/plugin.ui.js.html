...
<head>
    <title>Code coverage report for solidity-coverage/plugins/resources/plugin.ui.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">solidity-coverage/plugins/resources</a> plugin.ui.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">const UI = require('./../../lib/ui').UI;
&nbsp;
/**
 * Plugin logging
 */
