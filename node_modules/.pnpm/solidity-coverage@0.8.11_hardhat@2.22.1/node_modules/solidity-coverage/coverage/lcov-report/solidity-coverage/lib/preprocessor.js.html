...
<head>
    <title>Code coverage report for solidity-coverage/lib/preprocessor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">solidity-coverage/lib</a> preprocessor.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const SolidityParser = require('@solidity-parser/parser');
&nbsp;
const crRegex = /[\r\n ]+$/g;
const OPEN = '{';
const CLOSE = '}';
...
<span class="cstat-no" title="statement not covered" >    contract = err;</span>
  }
  return contract;
};
&nbsp;
