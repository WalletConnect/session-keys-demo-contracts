...
<head>
    <title>Code coverage report for solidity-coverage/lib/injector.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">solidity-coverage/lib</a> injector.js</h1>
        <div class='clearfix'>
...
<a name='L475'></a><a href='#L475'>475</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const web3Utils = require("web3-utils");
&nbsp;
class Injector {
  constructor(viaIR){
    this.viaIR = viaIR;
...
&nbsp;
    ...
    const linecount = ( newLines || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.length + 1;
