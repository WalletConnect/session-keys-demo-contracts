...
<head>
    <title>Code coverage report for solidity-coverage/lib/parse.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">solidity-coverage/lib</a> parse.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.06% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>132/136</span>
            </div>
...
<span class="cline-any cline-yes">1282x</span>
<span class="cline-any cline-yes">1282x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
// Nodes
parse.AssignmentExpression = <span class="fstat-no" title="function not covered" >fu</span>nction(contract, expression) {
<span class="cstat-no" title="statement not covered" >  register.statement(contract, expression);</span>
};
&nbsp;
...
parse.FunctionCall = function(contract, expression, skipStatementRegistry) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (expression.expression.type !== 'FunctionCall') {
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    parse[expression.expression.type] &amp;&amp;</span>
    parse[expression.expression.type](contract, expression.expression);
  }
};
&nbsp;
...
&nbsp;
    ...
    if (expression.baseContracts &amp;&amp; expression.baseContracts.length){
      for (let base of expression.baseContracts ){
        <span class="missing-if-branch" title="else path not taken" >E</span>if (base.range[1] &gt; start){
          start = base.range[1];
        }
      }
    } else {
...
&nbsp;
    (contract.injectionPoints[loc])
      ? <span class="branch-0 cbranch-no" title="branch not covered" >contract.injectionPoints[loc].push({ type: 'injectHashMethod', contractName: expression.name})</span>
      : contract.injectionPoints[loc] = [{ type: 'injectHashMethod', contractName: expression.name}];
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (expression.subNodes) {
...
parse.Modifiers = function(contract, modifiers) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (modifiers) {
    modifiers.forEach(modifier =&gt; {
      parse[modifier.type] &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >parse[modifier.type](contract, modifier);</span>
    });
  }
};
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >  parse[expression.typeName.type](contract, expression.typeName);</span>
};
&nbsp;
...
&nbsp;
parse.UsingStatement = <span class="fstat-no" title="function not covered" >fu</span>nction (contract, expression) {
<span class="cstat-no" title="statement not covered" >  parse[expression.for.type] &amp;&amp;</span>
