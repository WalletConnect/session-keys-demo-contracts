...
<head>
    <title>Code coverage report for solidity-coverage/plugins/resources/nomiclabs.ui.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">solidity-coverage/plugins/resources</a> nomiclabs.ui.js</h1>
        <div class='clearfix'>
...
<a name='L92'></a><a href='#L92'>92</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">39x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">39x</span></td><td class="text"><pre class="prettyprint lang-js">const UI = require('./../../lib/ui').UI;
&nbsp;
/**
...
&nbsp;
   ...
   */
  report(kind, args=<span class="branch-0 cbranch-no" title="branch not covered" >[])</span>{
    const c = this.chalk;
...
&nbsp;
module.exports = PluginUI;</pre></td></tr></table></pre>
