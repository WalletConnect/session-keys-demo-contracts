...
<head>
    <title>Code coverage report for solidity-coverage/lib/abi.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">solidity-coverage/lib</a> abi.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">const ethersABI = require("@ethersproject/abi");
const difflib = require('difflib');
&nbsp;
class AbiUtils {
&nbsp;
  diff(orig=<span class="branch-0 cbranch-no" title="branch not covered" >{},</span> cur=<span class="branch-0 cbranch-no" title="branch not covered" >{})</span>{
    let plus = 0;
    let minus = 0;
&nbsp;
...
&nbsp;
  generateHumanReadableAbiList(_artifacts, sha){
    const list = [];
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_artifacts.length){
...
&nbsp;
module.exports = AbiUtils;</pre></td></tr></table></pre>
