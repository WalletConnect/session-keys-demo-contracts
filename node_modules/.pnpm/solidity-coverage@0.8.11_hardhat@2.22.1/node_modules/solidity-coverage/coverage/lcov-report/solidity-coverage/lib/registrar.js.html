...
<head>
    <title>Code coverage report for solidity-coverage/lib/registrar.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">solidity-coverage/lib</a> registrar.js</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (modifier.range[1] &gt; start){
...
&nbsp;
  ...
  requireBranch(contract, expression) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.enabled.branches) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
